...
import { getWhatAppListing } from "../apiCalls/getWechatListing";
...
function WhatsAppListing() {
    ...
    const fetchWechatListing = async () => {
        try {
            const { data } = await getWhatAppListing()
            setData(data)
        } catch (error) {
            setData([] )
        }
            ...
            <div className="flex flex-col usage-container w-full">
                ...
                <div className="bg-white">
                    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900">WhatApp Listing</h2>
