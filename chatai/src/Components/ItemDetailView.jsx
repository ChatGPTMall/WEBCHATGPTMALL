...
function ItemDetailView() {
  ...
  const fetchItemDetails = async () => {
    try {
      setLoading(true);
      const data = await getItemDetails({ item_id: params.productId });
      console.log(data);
      setItemData(data);
      setLoading(false);
    } catch (error) {
    ...
    <div className="item-detail-view d-flex justify-content-center align-items-center">
      ...
      >
        {loading ? (
          ...
          <>
            <Helmet>
              <meta name="title" content={itemData.title} />
            ...
            <div
              className="w-75 d-flex h-100   flex-column p-5"
            ...
            >
              ...
              <div className="w-100 d-flex my-2">
                <strong className="mx-3">Description:</strong>
